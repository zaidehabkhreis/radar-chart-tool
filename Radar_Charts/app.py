...
# Return how many total charts exist (after filters)
...
# Single chart generation for iframe
@app.route('/chart/<sheet_name>')
def generate_chart(sheet_name):
    user = get_authenticated_user(request)
    if not user:
...
# Return exactly one chart snippet at given offset
